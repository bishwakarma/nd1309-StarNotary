...
contract StarNotary is ERC721 {
    ...
    string public constant name = 'Claim Star';
    // symbol: Is a short string like 'USD' -> 'American Dollar'
    string public constant symbol = 'CLST';
    ...
    function exchangeStars(uint256 _tokenId1, uint256 _tokenId2) public {
        ...
        require(ownerAddress1 == msg.sender || ownerAddress2 == msg.sender, "You must be the owner of either tokens");
    ...
    function transferStar(address _to1, uint256 _tokenId) public {
        ...
        address ownerAddress = ownerOf(_tokenId);
        require(ownerAddress == msg.sender, "You must be the owner of the start you want to transfer");
